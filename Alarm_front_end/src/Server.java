...
public class Server extends UnicastRemoteObject implements Service {
    ...
    //This method is to get Alarm data from the API Server. This is called every 15 seconds.
    @Override
    ...
    public String[] loginAdmin(String userName, String password) throws RemoteException {
        ...
        try {
            ...
            HttpResponse<String> response = Unirest.post("http://localhost:8080/api/auth/signin") //Http POST request to the API Server.
                    .header("Content-Type", "application/json")
                    .body(jsonString) //Passing the JSON data to the API Server.
                    .asString();

            JSONObject myResponse = new JSONObject(response.getBody().toString()); //Creating an JAONObject to collect response.
    ...
    public String[] addAlarmSensor(String jsonDetails, String token) throws RemoteException {
        ...
        try {
            ...
            HttpResponse<String> responseGet = Unirest.post("http://localhost:8080/api/admin/addSensor") //POST Request.
    ...
    public String[] updateAlarmSensor(String jsonDetails, String token) throws RemoteException {
        ...
        try {
            ...
            HttpResponse<String> response = Unirest.put("http://localhost:8080/api/admin/updateSensor")  //Perform the PUT Action.
                    .header("Authorization", "Bearer " + token) //Passing the Admin Token to get the permission to the update process.
                    .header("Content-Type", "application/json")
                    .body(jsonDetails) //Pass the created JSON Data to the PUT request.
                    .asString();
